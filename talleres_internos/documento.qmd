...
Esto creará un nuevo repositorio GIT en tu directorio actual. Conceptos clave de GIT- HEAD: Es una referencia al último commit en la rama actualmente activa.
...
- En el cuadro de diálogo que aparece, selecciona Reveal.js Slide Presentation y luego haz clic en OK.
Esto creará un nuevo archivo Quarto con la extensión .qmd.
...
## Trabajando con Branches y Pull Requests en GITCrear una nueva Branch
...
Ahora estás en la branch clase-python y puedes empezar a hacer cambios.
Crear Commits en la BranchVamos a suponer que estás desarrollando el contenido de una clase de Python y quieres dividir tu trabajo en tres commits: contenido conceptual, contenido de programación y contenido multimedia. Aquí te mostramos cómo hacerlo:
...
Hacer un Pull RequestUna vez que hayas terminado de desarrollar tu clase y hayas hecho todos tus commits, puedes hacer un pull request para fusionar tus cambios con la branch principal.
