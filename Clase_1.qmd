...
## Pyhton, un lenguahe _open source_
...
::: {.column-margin}
Puedes acceder a la Python Software Foundation en este enlace
[Python Software Foundation](http://staging.python.org/psf/)
:::

# Los elementos de un lenguaje de programación

1. __Sintaxis:__ Se refiere a las reglas que definen cómo se deben escribir y organizar las instrucciones en un programa. En Python, por ejemplo, los bloques de código se definen por su indentación.

2. __Semántica:__ Se refiere al significado de las instrucciones y expresiones en un programa. Por ejemplo, en Python, el operador + tiene una semántica diferente dependiendo de si se usa con números (donde realiza una suma) o con cadenas (donde realiza una concatenación).
...
3. __Pragmática:__  Se refiere a cómo y por qué se utilizan ciertas construcciones y patrones de programación en un lenguaje. Por ejemplo, en Python, es común utilizar listas por comprensión para transformar listas de una manera concisa y legible.
...
- _Pandas:_ Es una biblioteca de manipulación y análisis de datos. Puedes instalarla con:

```
pip install pandas

```
- _NumPy:_ Es una biblioteca para el cálculo científico con Python. Puedes instalarla con:
...
- _SciPy:_ Es una biblioteca que se utiliza para cálculos científicos y técnicos. Puedes instalarla con:
...
- _Matplotlib:_ Es una biblioteca para la creación de gráficos estáticos, animados e interactivos en Python. Puedes instalarla con:
